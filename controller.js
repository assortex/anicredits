...
AniCredits.controller('DisplayPanel', function ($scope) {
  $scope.events = [
	...
	{'title': 'Fate/Stay Night: Unlimited Blade Works','credit': '©TYPE-MOON,ufotable,FSNPC'},
	{'title': 'Milpom★','credit': '©OSO/BNP,COVER,ASOBISYSTEM,VITHMIC'},
	...
	{'title': 'MOBILE SUIT GUNDAM IRON-BLOODED ORPHANS','credit': '©SOTSU・SUNRISE・MBS'},
	{'title': 'Saint Seiya -soul of gold-','credit': ' ©Masami Kurumada／Saint Seiya soul of gold Production committee'},
	...
	{'title': 'JK-Meshi!','credit': '(C)「JKめし！」製作委員会'},
	...
	{'title': 'Kyoufu! Zombie Neko','credit': '© kanahei / TXCOM / ZNP'},
	{'title': 'Lance N\' Masques','credit': '© 子安秀明/ポニーキャニオン・ProjectLNM'},
	{'title': 'Lupin III - L\'avventura Italiana','credit': '原作 : モンキー・パンチ © TMS'},
	{'title': 'Miss Monochrome: The Animation','credit': '© Miss Monochrome Committee'},
	{'title': 'Neko Nanka Yondemo Konai.','credit': '(c)杉作/実業之日本社'},
	...
	{'title': 'Peeping Life TV: Season 1??','credit': '©NTV/Tatsunoko/Tezuka/CoMix Wave/NTVM'},
	...
	{'title': 'Ansatsu Kyoushitsu','credit': '(c)松井優征 / 集英社・アニメ「暗殺教室」製作委員会'},
	{'title': 'Binan Koukou Chikyuu Bouei-bu Love!','credit': '©馬谷くらり／黒玉湯'},
	{'title': 'Death Parade','credit': '©立川譲／「デス・パレード」製作委員会'},
	{'title': 'Doamaiger D','credit': '©甘匠堂'},
	{'title': 'Dog Days″','credit': '© PROJECT DD3'},
	{'title': 'Durarara!! x2 Shou','credit': 'Copyright 成田良悟／ＫＡＤＯＫＡＷＡ アスキー・メディアワークス刊／池袋ダラーズ'},
	{'title': 'Go! Princess Precure','credit': '©ABC・東映アニメーション'},
	{'title': 'Isuca','credit': '©2014 高橋脩／KADOKAWA 角川書店刊／「ISUCA-イスカ-」製作委員会'},
	{'title': 'Junketsu no Maria','credit': '©石川雅之・講談社／純潔のマリア製作委員会'},
	{'title': 'Juuou Mujin no Fafnir','credit': '©ツカサ／講談社 イラスト：梱枝りこ'},
	{'title': 'Kamisama Hajimemashita◎','credit': '© Julietta Suzuki / Hakusensha-Kamisama Kiss Project. Julietta Suzuki / Hakusensha-Kamisama Kiss 2 Project All Rights Reserved. '},
	{'title': 'Kantai Collection: KanColle','credit': '©2014 「艦これ」連合艦隊司令部'},
	{'title': 'Koufuku Graffiti','credit': '©川井マコト・芳文社／幸腹グラフィティ製作委員会©'},
	{'title': 'Kuroko\'s Basketball Season 3','credit': '©Tadatoshi Fujimaki/SHUEISHA, Team Kuroko'},
	{'title': 'Military!','credit': '©まもウィリアムズ/一迅社・クラコウジア公国軍極東部隊 2015'},
	{'title': 'Rolling☆Girls','credit': '© 2015 “The Rolling Girls” Production Committee'},
	{'title': 'Saenai Heroine no Sodatekata','credit': '(C)2015 丸戸史明・深崎暮人・KADOKAWA 富士見書房／冴えない製作委員会'},
	{'title': 'Seiken Tsukai no World Break','credit': '©あわむら赤光・SBクリエイティブ/ワルブレ製作委員会'},
	{'title': 'Sengoku Musou','credit': '(C)コーエーテクモゲームス/アニメ戦国無双製作委員会'},
	{'title': 'Shinmai Maou no Testament','credit': '©2015 上栖 綴人・Nitroplus ／ KADOKAWA　角川書店刊／「新妹魔王の契約者」製作委員会'},
	{'title': 'Shounen Hollywood: Holly Stage for 50','credit': '© Noel Japan Agency'},
	{'title': 'Soukyuu no Fafner: Dead Aggressor - Exodus','credit': '(C)XEBEC・FAFNER EXODUS PROJECT ｜ (C)Copyright King Record.Co.,Ltd. All Right Reserved.'},
	{'title': 'Tantei Kageki Milky Holmes TD','credit': '©ミルキィTD製作委員会'},
	{'title': 'The IDOLM@STER: Cinderella Girls','credit': '©BNGI / PROJECT CINDERELLA'},
	{'title': 'Tokyo Ghoul √A','credit': '© Sui Ishida/Shueisha, Tokyo Ghoul Production Committee'},
	{'title': 'Tsukimonogatari: Yotsugi Doll','credit': '©西尾維新／講談社・アニプレックス・シャフト'},
	{'title': 'Yoru no Yatterman','credit': '©タツノコプロ・夜ノヤッターマン製作委員会 2015'},
	{'title': 'Yuri Kuma Arashi','credit': '（C）2015 イク二ゴマモナカ/ユリクマ二クル'},
	{'title': 'Bikini Warriors','credit': '©HOBBY JAPAN'},
	{'title': 'Persona 4 the Golden ANIMATION','credit': '©ATLUS (C)SEGA/P4GA Committee'},
	{'title': 'SUSHI NINJA','credit': '©GENCO'},
	{'title': 'THE IDOLM@STER','credit': '©BNEI／PROJECT iM@S'},
	{'title': 'M3 the dark metal','credit': ' ©Junichi Sato,Mari Okada,Satelight/M3 PROJECT'},
	{'title': 'KILL la KILL','credit': '©TRIGGER,Kazuki Nakashima/Kill la Kill Partnership'},
	{'title': 'ALDNOAH.ZERO','credit': ' ©Olympus Knights/Aniplex,Project AZ'},
	...
	{'title': 'Blood Blockade Battlefront','credit': '©2015 Yasuhiro Nightow/Shueisha,Blood Blockade Battlefront Project'},
